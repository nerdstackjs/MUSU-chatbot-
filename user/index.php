...
<html lang="en">
    ...
    <body onload="template()" style="background-image: url('user-background.jpg'); background-size: cover; ">
         ...
         <input type="button" class="btn btn-warning btn-sm" style="margin-left: 10px;" value="Admin" onclick="window.location='http://localhost/chatbott/admin/';" >
        ...
        echo 'window.location.href = "mainbot.php"'; 
        echo '</script>';
        }
